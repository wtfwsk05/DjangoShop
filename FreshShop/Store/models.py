...
class Store(models.Model):
    ...
    store_descrition = models.TextField(verbose_name='店铺描述')
...
class Goods(models.Model):
    ...
    goods_number = models.IntegerField( verbose_name='商品库存数')
    ...
    goods_under = models.IntegerField(verbose_name='商品状态',default=1) # 0下架 1待售
